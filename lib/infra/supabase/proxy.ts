...
const PUBLIC_PREFIXES = [
  ...
  */
  // An uptime checker has no session. The route answers two booleans and a
  // timestamp and nothing else; see `app/api/health/route.ts`.
  "/api/health",
  "/robots.txt",
  "/sitemap.xml",
  "/opengraph-image",
